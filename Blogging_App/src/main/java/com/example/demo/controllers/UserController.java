...
public class UserController {
	...
	//delete
	//ResponseEntity<?>--> '?' if don't know data type 
	@DeleteMapping("/{uid}")
	public ResponseEntity<ApiResponse> deleteUser(@PathVariable("uid") Integer userId)
	{
		this.userService.deleteUser(userId);
		//deleteUser return void
	...
	//fetch a user
	@GetMapping("/{uid}")
	public ResponseEntity<UserDto> getUser(@PathVariable("uid") Integer userId)
	{
